...
public class HardDiskBuilder {
	...
	public HardDiskBuilder vendor(String vendor) {
		this.vendor = vendor;
		return this;
	}

	public HardDiskBuilder name(String name) {
		this.name = name;
		return this;
	}

	public HardDiskBuilder price(double price) {
		this.price = price;
		return this;
	}

	public HardDiskBuilder dimension(Dimension dimension) {
		this.dimension = dimension;
		return this;
	}

	public HardDiskBuilder weight(double weight) {
		this.weight = weight;
		return this;
	}
